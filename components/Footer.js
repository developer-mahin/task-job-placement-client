...
const Footer = () => {
    return (
        ...
        <footer className="lg:pt-16 pt-0 sm:p-6 container mx-auto px-3">
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-gray-500 sm:text-center">© 2022 <Link href="/" className="hover:underline">Flowbite™</Link>. All Rights Reserved.
                </span>
                <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                    <Link href="/" className="text-gray-500 hover:text-gray-900 dark:text-gray-200">
