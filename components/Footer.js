...
const Footer = () => {
    return (
        ...
        <footer class="lg:pt-16 pt-0 bg-white sm:p-6 container mx-auto px-3">
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center">© 2022 <Link href="/" class="hover:underline">Flowbite™</Link>. All Rights Reserved.
                </span>
